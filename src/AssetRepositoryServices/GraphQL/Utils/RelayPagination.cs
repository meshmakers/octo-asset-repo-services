...
internal static class RelayPagination
{
    ...
    ///     <a href="https://facebook.github.io/relay/graphql/connections.htm#sec-Pagination-algorithm">
    ...
    /// <param name="first">
    ///     Maximum number of edges to return after <paramref name="after" /> (if provided) or from
    ///     the start of the edge list.
    /// </param>
    /// <param name="after">Only return edges coming after the edge represented by this cursor.</param>
    /// <param name="last">
    ///     Maximum number of edges to return before <paramref name="before" /> (if provided)
    ///     or from the end of the edge list.
    /// </param>
    ...
    private static EdgeRange ApplyCursorToEdges(int edgeCount, string? after, string? before)
    {
        ...
        var startOffset = afterOffset + 1;
        var endOffset = beforeOffset - 1;
