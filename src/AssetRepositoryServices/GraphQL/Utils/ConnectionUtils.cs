...
internal static class ConnectionUtils
{
    ...
    public static OctoConnection<TSource> ToOctoConnection<TSource, TParent>(
    ...
    )
    {
        ...
        return ToOctoConnection(list, context, 0, list.Count, aggregationResult, fieldAggregationResults, strictCheck);
    }
    ...
    {
        var list = items.ToList();
        return ToConnection(list, context, 0, list.Count, strictCheck);
    }
