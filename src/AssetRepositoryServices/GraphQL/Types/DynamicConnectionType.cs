...
public sealed class DynamicConnectionType : ObjectGraphType
{
    ...
    public DynamicConnectionType(string name, string description, IGraphType itemType, IGraphType edgeType)
    {
        ...
        Field<NonNullGraphType<PageInfoType>>("pageInfo").Description("Information to aid in pagination.");
        ...
        Field<ListGraphType<GroupingResultType>>("groupings").Description("Result of grouping the items by attributes.");
